...
CREATE TABLE CART(USERID INTEGER, ITEMID INTEGER, ITEMSERIALNUMBER INTEGER, ITEMCATEGORY VARCHAR(50), ITEMBRAND VARCHAR(50), ITEMNAME VARCHAR(50), ITEMIMAGE VARCHAR(250), ITEMQTY INTEGER);