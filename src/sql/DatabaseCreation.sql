...
CREATE TABLE PAYMENT (PAYMENTID INTEGER NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), ORDERID INTEGER REFERENCES ORDER(ORDERID),
PAYMENTINFOID INTEGER REFERENCES PAYMENTINFO(PAYMENTINFOID), PAYMENTDATE DATE,
