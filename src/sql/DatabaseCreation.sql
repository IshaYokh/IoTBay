...
CREATE TABLE PAYMENTINFO (PAYMENTINFOID INTEGER NOT NULL, USERID INTEGER REFERENCES USERS(USERID), CARDHOLDERNAME VARCHAR(50), CARDNUMBER VARCHAR(20),
...
SUBURB VARCHAR(50) NOT NULL, "STATE" VARCHAR(3) NOT NULL, POSTCODE INTEGER NOT NULL, COUNTRY VARCHAR(50), PRIMARY KEY (PAYMENTINFOID));
