...
public class DBManager {
    ...
    public void addStaff(int userID, String dob) throws SQLException{
     ...
     String fetch = "INSERT INTO TEMP.STAFF VALUES (" + userID + ", 0,'" +dob+ "')" ;
     st.execute(fetch);
    }
    ...
    public void deleteCustomer(int userID) throws SQLException{
     ...
     String fetch = "DELETE FROM TEMP.CUSTOMER WHERE USERID=" + userID;
   ...
   public void editUser(String firstname, String lastname, String password, String phonenumber, String streetnumber, String streetname, String streettype, String suburb, String state, String postcode, String country, String email, int userID) throws SQLException{
        //st.executeUpdate();
        String fetch = "UPDATE TEMP.USERS SET FIRSTNAME = '"+ firstname + "', LASTNAME = '" + lastname + "', PASSWORD = '" + password + "', PHONENUMBER = " + phonenumber + ", STREETNUMBER = " + streetnumber + ", STREETNAME = '" + streetname + "', STREETTYPE = '" + streettype + "', SUBURB= '"+ suburb + "', STATE = '" + state + "', postcode =" + postcode + ", COUNTRY='" + country + "', EMAIL ='" + email +"' WHERE USERID =" + userID ;
    ...
    public int getUserID(String email, String password) throws SQLException{
        ...
        String fetch = "SELECT EMAIL, PASSWORD, USERID from TEMP.USERS WHERE EMAIL = '" + email + "' AND PASSWORD = '" + password +"'" ;
        ResultSet rs = st.executeQuery(fetch);
    ...
    public void deleteUser(int userID) throws SQLException{
        //st.executeUpdate();
       String fetch = "DELETE FROM TEMP.USERS WHERE USERID=" + userID;
    ...
    public void addlogslogout(int userID) throws SQLException{
        ...
        String fetch = "INSERT INTO TEMP.ACCLOGS (USERID, ACTION ,Current_Time_Stamp) VALUES (" + userID +",'"  + logout1 +  "',CURRENT_TIMESTAMP)";
        st.executeUpdate(fetch);
    ...
    public void addlogslogin(int userID) throws SQLException{
        ...
        String fetch = "INSERT INTO TEMP.ACCLOGS (USERID, ACTION ,Current_Time_Stamp) VALUES (" + userID +",'"  + login1 +  "',CURRENT_TIMESTAMP)";
        st.executeUpdate(fetch);
    ...
    String fetch = "select * from TEMP.ACCLOGS where USERID ="+ userID;
    ResultSet rs = st.executeQuery(fetch);
