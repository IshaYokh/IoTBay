<%-- 
    Document   : upgrade
    Created on : 10/05/2021, 3:29:15 AM
    Author     : Kevin
--%>
            ...
            <form method="post" action="/admin/user/update?id=<%=id%>">
                ...
                <div class="d-flex">
                    <div class="mb-1 mx-2 w-100">
                        ...
                        <input name="DOB" value="<%= updateUser.getFirstName()%>" type="text" class="form-control" id="DOB" max="50">
                    </div>
                    <div class="mb-1 mx-2 w-100">
                        <label for="SITEACCESSLEVEL" class="form-label">Last Name</label>
                        <input name="siteAccessLevel" value="<%= updateUser.getLastName()%>" type="text" class="form-control" id="SITEACCESSLEVEL" max="50">
                    </div> 
                </div>
